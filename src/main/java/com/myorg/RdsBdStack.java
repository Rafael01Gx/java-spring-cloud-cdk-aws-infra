...
public class RdsBdStack extends Stack {

    public RdsBdStack(final Construct scope,final String id,final Vpc vpc){
        this(scope,id,null,vpc);

    }

    public RdsBdStack(final Construct scope,final String id,final StackProps props,final Vpc vpc){
        ...
        DatabaseInstance database = DatabaseInstance.Builder
                ...
                .engine(DatabaseInstanceEngine.mysql(
                        MySqlInstanceEngineProps.builder()
                                .version(MysqlEngineVersion.VER_8_4_7).build() ))
                .vpc(vpc)
